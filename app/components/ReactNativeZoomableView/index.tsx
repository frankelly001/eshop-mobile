...
interface ReactNativeZoomableViewProps {
  // options
  zoomEnabled?: boolean;
  initialZoom?: number;
...
interface ReactNativeZoomableViewState {
  offsetX: number;
  offsetY: number;
  lastX: number;
  lastY: number;
...
> {
  ...
  _doubleTapCheck = (e: any, gestureState: any) => {
    ...
    if (
      ...
      now - this.lastPressHolder < this.props.doubleTapDelay
    ) {
